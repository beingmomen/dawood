...
const EventPage = () => {
  ...
  const event = {
    ...
    description: 'ندوة تفاعلية شاملة لمناقشة استراتيجيات التنمية المستدامة والحلول البيئية المبتكرة في المملكة العربية السعودية، بمشاركة خبراء محليين ودوليين في مجال البيئة والتنمية.',
    fullDescription: `
      <p>تأتي هذه الندوة في إطار الجهود المستمرة لتعزيز الوعي البيئي وتطوير استراتيجيات التنمية المستدامة في المملكة العربية السعودية. ستركز الندوة على عدة محاور رئيسية تشمل:</p>
      ...
      <h3>المتحدثون:</h3>
      <p>ستضم الندوة نخبة من الخبراء والمتخصصين في مجال التنمية المستدامة من داخل المملكة وخارجها، بالإضافة إلى ممثلين من القطاع الحكومي والخاص والمجتمع المدني.</p>
    ...
    time: '10:00 ص',
    endTime: '4:00 م',
    location: 'قاعة المؤتمرات الكبرى - فندق الريتز كارلتون الرياض',
    attendees: 250,
    maxAttendees: 300,
    status: 'قادم',
    ...
    agenda: [
      ...
      { time: '11:00 - 12:00', activity: 'الجلسة الأولى: الطاقة المتجددة في المملكة' },
