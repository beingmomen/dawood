  ...
  const statements = [
    {
      ...
      fullContent: `
        <p>يأتي هذا البيان في ضوء التحديات الكبيرة التي تواجه منظومة التعليم العالي في المملكة، والحاجة الملحة لإصلاحات جذرية تضمن مواكبة التطورات العالمية وتلبية احتياجات سوق العمل.</p>
    ...
    },
    {
      ...
      fullContent: `
        <p>تشهد المملكة مرحلة مهمة من الإصلاحات الاقتصادية في إطار رؤية 2030، وهو ما يتطلب توازناً دقيقاً بين تحقيق الأهداف التنموية وضمان العدالة الاجتماعية.</p>
    ...
    },
    {
      ...
      fullContent: `
        <p>يتطلب النظام الصحي في المملكة إصلاحات جذرية لمواجهة التحديات المتزايدة وضمان تقديم خدمات صحية عالية الجودة لجميع المواطنين.</p>
    ...
    },
    {
      ...
      excerpt: 'بيان يوضح الرؤية حول السياسة الخارجية للمملكة ودورها في تعزيز السلام والاستقرار الإقليمي والدولي',
      fullContent: `
        <p>تلعب المملكة العربية السعودية دوراً محورياً في المنطقة والعالم، وهو ما يتطلب سياسة خارجية متوازنة تخدم المصالح الوطنية وتعزز السلام العالمي.</p>
