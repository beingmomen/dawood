<template>
  <header :class="headerClasses">
    ...
    >
      <div v-if="isMenuOpen" class="md:hidden bg-white border-t shadow-lg overflow-hidden">
...
const menuItems = [
  ...
  { name: 'البيانات الصحفية', href: '/press-statements', icon: 'lucide:file-text' },
]
...
const getNavLinkClasses = (href) => {
  ...
  const baseClasses = 'font-medium transition-colors duration-300 px-3 py-2 rounded-lg'
