...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-32 left-16 w-16 h-16 bg-white/10 rounded-full animate-float"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute top-1/2 left-1/4 w-12 h-12 bg-white/10 rounded-full animate-float"
